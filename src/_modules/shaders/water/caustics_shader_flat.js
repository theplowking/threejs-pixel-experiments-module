...
const CausticsShader = {
    ...
    vertexShader: /* glsl */`
        ...
        flat varying vec3 vTriangleColor;

        void main() {
            vUv = uv;
            
            // Sample texture at this vertex
            vec3 vertexColor = texture2D(uTexture, uv).rgb;
            vTriangleColor = vertexColor;
    ...
    fragmentShader: /* glsl */`
        ...
        vec3 finalColor = vTriangleColor + opacity * caustics * uCausticsColor;
